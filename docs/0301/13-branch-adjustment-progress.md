...
| `parallel-saga` | Validated | `800babe` | 42 | `mvn -pl saga-shared test -Dtest=EventSchemaConformanceTests` | Pass | Added `saga-shared/src/main/resources/saga-implementation.properties` with parallel coordinates |
...
## Baseline Snapshot
- Branches currently identical to `main`: none.
